...
ENTRYPOINT ["exec", "GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID}", "GOOGLE_CLIENT_SECRET=${GOOGLE_CLIENT_SECRET}",  \
    "GITHUB_CLIENT_ID=${GITHUB_CLIENT_ID}", "GITHUB_CLIENT_SECRET=${GITHUB_CLIENT_SECRET}", \
    "DATABASE_URL=${DATABASE_URL}", "DATABASE_USERNAME=${DATABASE_USERNAME}", \
    "DATABASE_PASSWORD=${DATABASE_PASSWORD}", "./gradlew run"]
